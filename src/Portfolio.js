...
import Palette from './assets/playfulpalette2.jpg'; 
        ...
        <div>
                ...
                <div className="row">
                    <div className="col-sm-6">
                        ...
                        <img className="portfolio-img" src={PaletteResults} alt="Playful Palette Results"/>
                    </div>
                    <div className="col-sm-6">
                        ...
                        Adobe's Playful Palette</a></span>, an interactive parametric color mixer for digital paint applications that mimics and enhances the traditional
                ...
                <div className="row">
                    ...
                    <div className="col-sm-5">
                        ...
                        and created Kessler Project, an all-day space adventure that allows guests to experience the excitement
                ...
                <div className="row">
                    ...
                    <div className="col-sm-5">
                        ...
                        <p className="p nyt">I also did some front-end developing for our intern-led 3-D Crossword <span><a href="https://johnwestwig.github.io/three-d-crossword/" target="_blank">project</a></span>.
                        </p>
                    </div>
                </div>
                </div>
                ...
                <div className="row">
                    ...
                    <img src={Molex3} alt="Molex" width="100%"/>
                        ...
                        <p className="p molex">As a Product Management Intern, I created a set of 
                        infographics and 3-D animations to market the company's new line 
