        ...
        return (
            <div>
                <div className="content-container portfolio">
                    ...
                    <img id="full-width" key="overview" src="https://i.postimg.cc/JzzWQbYN/overview.png"
                         alt="overview"/><br/><br/>
                    <div className="row">
                        <h5>Background</h5><br/>
                        ...
                        <div id="row">
                            <div id="column">
                                <img id="half-width" key="sketch1" src="https://i.postimg.cc/RFRRGnDt/sketch1.jpg" alt="sketch"/><br/><br/><br/>
                            </div>
                            <div id="column">
                                <img id="half-width" key="sketch3" src="https://i.postimg.cc/prcBMMxX/sketch3.jpg" alt="sketch"/><br/><br/><br/>
                            </div>
                        </div>
                        ...
                        <h5>Redesign</h5><br/>
                        <p>The primary focus of the redesign was to separate artifact types into their own copy
                            workflows.<br/>
                        ...
                        <a href="https://www.figma.com/proto/TIHIYPfyhvmQiSWxfzz5i1/Untitled?node-id=1-400&scaling=
                            min-zoom&page-id=0%3A1&starting-point-node-id=1%3A137">Link to redesign in
                            Figma</a><br/><br/>
                        <p>Instead of copying all artifact types at once, the user can now select an artifact from the
                            left panel. The following steps then apply to all artifacts to copy:</p>
                        <ul>
                            ...
                            <li>Hit Copy. Instead of directly starting the copy process, a dialog window will appear
                                for the user to select the destination sandbox and verify dependencies.
                            </li>
                            <li>After the user hits Copy, the job status of each artifact and its dependencies will
                                update in real-time to indicate a success or otherwise.
                            </li>
                        </ul>
                        <p>Scalability<br/>
