...
var {
  Tooltip,
  TooltipTrigger
} = require("@react-spectrum/tooltip");
...
function $d1ce1419524cab384aad70acd928619$var$ActionGroup(props, ref) {
  ...
  let {
    ...
    summaryIcon
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["isEmphasized", "density", "isJustified", "isDisabled", "orientation", "isQuiet", "staticColor", "overflowMode", "onAction", "buttonLabelBehavior", "summaryIcon"]);

  let domRef = useDOMRef(ref);
  let wrapperRef = useRef(null);
  let state = useListState(_babelRuntimeHelpersExtends({}, props, {
  ...
  let updateOverflow = useCallback(() => {
    ...
    let computeVisibleItems = visibleItems => {
      ...
      if (isShowingMenu) {
        calculatedSize += orientation === 'horizontal' ? $d1ce1419524cab384aad70acd928619$var$outerWidth(listItems.pop(), false, true) : $d1ce1419524cab384aad70acd928619$var$outerHeight(listItems.pop(), false, true);
      }
  ...
  if (overflowMode === 'collapse' && visibleItems < state.collection.size) {
    ...
    menuItem = /*#__PURE__*/_react.createElement($d1ce1419524cab384aad70acd928619$var$ActionGroupMenu, _babelRuntimeHelpersExtends({}, menuProps, {
      items: menuChildren,
      onAction: onAction,
...
function $d1ce1419524cab384aad70acd928619$var$ActionGroupMenu(_ref2) {
  let {
    ...
    orientation
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(_ref2, ["state", "isDisabled", "isEmphasized", "staticColor", "items", "onAction", "summaryIcon", "hideButtonText", "isOnlyItem", "orientation"]);
  ...
  return (
    ...
    }, /*#__PURE__*/_react.createElement(PressResponder, mergeProps(buttonProps, hoverProps), /*#__PURE__*/_react.createElement(ActionButton, _babelRuntimeHelpersExtends({}, otherProps, {
      id: id,
