...
import _react, { forwardRef, useCallback, useMemo, useRef, useState } from "react";
import { Provider, useProviderProps } from "@react-spectrum/provider";
import { PressResponder, useHover } from "@react-aria/interactions";
import _spectrumIconsWorkflowMore from "@spectrum-icons/workflow/More";
import { useListState } from "@react-stately/list";
import { Item as _Item, Menu, MenuTrigger } from "@react-spectrum/menu";
...
function $c6c692da1cfbbd16b5ce1db157471b0$var$ActionGroup(props, ref) {
  ...
  let {
    ...
    summaryIcon
      ...
      otherProps = _babelRuntimeHelpersEsmObjectWithoutPropertiesLoose(props, ["isEmphasized", "density", "isJustified", "isDisabled", "orientation", "isQuiet", "staticColor", "overflowMode", "onAction", "buttonLabelBehavior", "summaryIcon"]);

  let domRef = useDOMRef(ref);
  let wrapperRef = useRef(null);
  let state = useListState(_babelRuntimeHelpersEsmExtends({}, props, {
  ...
  let {
    styleProps
  } = useStyleProps(props); // Only hide button text if every item contains more than just plain text (we assume an icon).
  ...
  let updateOverflow = useCallback(() => {
    ...
    let computeVisibleItems = visibleItems => {
      ...
      if (isShowingMenu) {
        calculatedSize += orientation === 'horizontal' ? $c6c692da1cfbbd16b5ce1db157471b0$var$outerWidth(listItems.pop(), false, true) : $c6c692da1cfbbd16b5ce1db157471b0$var$outerHeight(listItems.pop(), false, true);
      }

      for (let [i, item] of listItems.entries()) {
        calculatedSize += orientation === 'horizontal' ? $c6c692da1cfbbd16b5ce1db157471b0$var$outerWidth(item, i === 0, i === listItems.length - 1) : $c6c692da1cfbbd16b5ce1db157471b0$var$outerHeight(item, i === 0, i === listItems.length - 1);
    ...
    setVisibleItems(function* () {
      let hideButtonText = buttonLabelBehavior === 'hide' && isIconCollapsible; // Update to show all items.
      ...
      let isMeasuring = newVisibleItems < state.collection.size && newVisibleItems > 0; // If not all of the buttons fit, and buttonLabelBehavior is 'collapse', then first try hiding
  ...
  }, [domRef, state.collection, setVisibleItems, overflowMode, selectionMode, buttonLabelBehavior, isIconCollapsible, orientation]); // Watch the parent element for size changes. Watching only the action group itself may not work
  ...
  let menuItem = null;
  let menuProps = {}; // If there are no visible items, don't apply any props to the action group container
  ...
  if (overflowMode === 'collapse' && visibleItems < state.collection.size) {
    ...
    menuItem = /*#__PURE__*/_react.createElement($c6c692da1cfbbd16b5ce1db157471b0$var$ActionGroupMenu, _babelRuntimeHelpersEsmExtends({}, menuProps, {
      items: menuChildren,
      onAction: onAction,
  ...
  }), /*#__PURE__*/_react.createElement(Provider, providerProps, children.map(item => /*#__PURE__*/_react.createElement($c6c692da1cfbbd16b5ce1db157471b0$var$ActionGroupItem, {
    key: item.key,
    onAction: onAction,
    isDisabled: isDisabled,
    isEmphasized: isEmphasized,
...
export const ActionGroup = /*#__PURE__*/forwardRef($c6c692da1cfbbd16b5ce1db157471b0$var$ActionGroup);
...
function $c6c692da1cfbbd16b5ce1db157471b0$var$ActionGroupItem(_ref) {
  ...
  if (hideButtonText && textContent) {
    button = /*#__PURE__*/_react.createElement(TooltipTrigger, {
...
function $c6c692da1cfbbd16b5ce1db157471b0$var$ActionGroupMenu(_ref2) {
  let {
    state,
    isDisabled,
    isEmphasized,
    ...
    orientation
      ...
      otherProps = _babelRuntimeHelpersEsmObjectWithoutPropertiesLoose(_ref2, ["state", "isDisabled", "isEmphasized", "staticColor", "items", "onAction", "summaryIcon", "hideButtonText", "isOnlyItem", "orientation"]);
  ...
  if (!summaryIcon && state.selectionManager.selectionMode === 'single' && state.selectionManager.disallowEmptySelection) {
    ...
    if (selectedItem) {
      ...
      if (typeof summaryIcon === 'string') {
        summaryIcon = /*#__PURE__*/_react.createElement(Text, null, summaryIcon);
      }
  ...
  if (summaryIcon) {
    ...
    summaryIcon = /*#__PURE__*/_react.createElement(_react.Fragment, null, /*#__PURE__*/_react.createElement(_spectrumIconsUiChevronDownMedium, {
      UNSAFE_className: classNames($b94f26c7d62d19d8f66eba0e11e8d03d$$interop$default, 'spectrum-ActionGroup-menu-chevron')
    }), /*#__PURE__*/_react.createElement("span", {
      className: classNames($b94f26c7d62d19d8f66eba0e11e8d03d$$interop$default, 'spectrum-ActionGroup-menu-contents', {
    ...
    _react.createElement(MenuTrigger, {
      ...
      slots: {
        text: {
          id: hideButtonText ? textId : null,
          isHidden: hideButtonText,
          UNSAFE_className: classNames($b94f26c7d62d19d8f66eba0e11e8d03d$$interop$default, 'spectrum-ActionGroup-menu-text')
        }
      }
    }, /*#__PURE__*/_react.createElement(PressResponder, mergeProps(buttonProps, hoverProps), /*#__PURE__*/_react.createElement(ActionButton, _babelRuntimeHelpersEsmExtends({}, otherProps, {
      id: id,
      "aria-label": ariaLabel,
      "aria-labelledby": ariaLabelledby,
      UNSAFE_className: classNames($b94f26c7d62d19d8f66eba0e11e8d03d$$interop$default, 'spectrum-ActionGroup-item', 'spectrum-ActionGroup-menu', {
        'is-hovered': isHovered,
        'is-selected': isSelected
      }, classNames($a0b8eb4b46824fd288195a4db8814b$$interop$default, {
        'is-selected': isSelected,
...
function $c6c692da1cfbbd16b5ce1db157471b0$var$outerWidth(element, ignoreLeftMargin, ignoreRightMargin) {
  let style = window.getComputedStyle(element);
  return element.offsetWidth + (ignoreLeftMargin ? 0 : $c6c692da1cfbbd16b5ce1db157471b0$var$toNumber(style.marginLeft)) + (ignoreRightMargin ? 0 : $c6c692da1cfbbd16b5ce1db157471b0$var$toNumber(style.marginRight));
}

function $c6c692da1cfbbd16b5ce1db157471b0$var$outerHeight(element, ignoreTopMargin, ignoreBottomMargin) {
  let style = window.getComputedStyle(element);
  return element.offsetHeight + (ignoreTopMargin ? 0 : $c6c692da1cfbbd16b5ce1db157471b0$var$toNumber(style.marginTop)) + (ignoreBottomMargin ? 0 : $c6c692da1cfbbd16b5ce1db157471b0$var$toNumber(style.marginBottom));
}

function $c6c692da1cfbbd16b5ce1db157471b0$var$toNumber(value) {
