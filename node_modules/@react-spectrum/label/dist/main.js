...
function $d2ecd00afec46f6300dcc47dcdc8$var$Field(props, ref) {
  let {
    ...
    elementType
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["label", "labelPosition", "labelAlign", "isRequired", "necessityIndicator", "includeNecessityIndicatorInAccessibilityName", "children", "labelProps", "elementType"]);
  ...
  return _react.cloneElement(children, mergeProps(children.props, _babelRuntimeHelpersExtends({}, styleProps, {
    ref
  })));
}

let Field = _react.forwardRef($d2ecd00afec46f6300dcc47dcdc8$var$Field);
