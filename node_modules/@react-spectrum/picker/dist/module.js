...
import _react, { useCallback, useRef, useState } from "react";
...
$bd296420f236ed913ddbbfab9a63cefc$exports = JSON.parse("{\"loading\":\"Ładowanie...\",\"placeholder\":\"Wybierz opcję...\"}");
...
var $db61695d117274776ec4e0e5a7b1b99a$exports = {};
$db61695d117274776ec4e0e5a7b1b99a$exports = JSON.parse("{\"loading\":\"A carregar...\",\"placeholder\":\"Selecionar uma opção...\"}");
...
const $f01f0d1066865f7027d77d32f5de6fe$var$intlMessages = {
  ...
  "pt-PT": _babelRuntimeHelpersEsmInteropRequireDefault($db61695d117274776ec4e0e5a7b1b99a$exports).default,
...
function $f01f0d1066865f7027d77d32f5de6fe$var$Picker(props, ref) {
  ...
  let listbox = /*#__PURE__*/_react.createElement(FocusScope, {
  ...
  }), /*#__PURE__*/_react.createElement(ListBoxBase, _babelRuntimeHelpersEsmExtends({}, menuProps, {
    ref: listboxRef,
    ...
    layout: layout,
    state: state,
    width: isMobile ? '100%' : undefined // Set max height: inherit so Tray scrolling works
    ,
    UNSAFE_style: {
      maxHeight: 'inherit'
    },
  ...
  return /*#__PURE__*/_react.cloneElement(picker, mergeProps(picker.props, _babelRuntimeHelpersEsmExtends({}, styleProps, {
    ref: domRef
  })));
}
/**
...
export const Picker = /*#__PURE__*/_react.forwardRef($f01f0d1066865f7027d77d32f5de6fe$var$Picker);
