...
let $a04c1031b5e1cab168e087a6837ba8be$var$FormContext = _react.createContext({});
...
const $a04c1031b5e1cab168e087a6837ba8be$var$formPropNames = new Set(['action', 'autoComplete', 'encType', 'method', 'target', 'onSubmit']);
...
function $a04c1031b5e1cab168e087a6837ba8be$var$Form(props, ref) {
  ...
  let {
    ...
    validationState
      ...
      otherProps = _babelRuntimeHelpersObjectWithoutPropertiesLoose(props, ["children", "labelPosition", "labelAlign", "isRequired", "necessityIndicator", "isQuiet", "isEmphasized", "isDisabled", "isReadOnly", "validationState"]);
  ...
  return /*#__PURE__*/_react.createElement("form", _babelRuntimeHelpersExtends({}, filterDOMProps(otherProps, {
    labelable: true,
...
const Form = _react.forwardRef($a04c1031b5e1cab168e087a6837ba8be$var$Form);
